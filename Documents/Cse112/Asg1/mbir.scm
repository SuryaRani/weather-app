...
;;this creates the hash table for statements
(define *stmt-table* (make-hash))


;; the function table is for all the functions to be interprette  
(define *function-table* (make-hash))

(for-each (lambda (var) (hash-set! *hash-table* (car var) (cadr var)))
   `(
           (+ , +) 
           (- , -) 
           (* , *)
